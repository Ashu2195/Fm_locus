...
echo  "20@$i@G@HapG\n" |sed 's/@/\t/g'>> ATGC.tsv
echo  "20@$i@C@HapC\n" |sed 's/@/\t/g'>> ATGC.tsv
java -jar /media/morpheus/sagar/kadak_part2/nano_pore_read_haplo/atlist10_file/jvarkit/dist/biostar214299.jar --samoutputformat BAM -p ATGC.tsv SRR25488572_Lueyang_Fm_subseted.bam > "$i"_"$kl".bam
