for i in ` cat Huxu_pos`
do
kl="SRR17968711_12"
echo  "CP100574.1@$i@A@HapA\n" |sed 's/@/\t/g' > ATGC.tsv
echo  "CP100574.1@$i@T@HapT\n" |sed 's/@/\t/g'>> ATGC.tsv
echo  "CP100574.1@$i@G@HapG\n" |sed 's/@/\t/g'>> ATGC.tsv
echo  "CP100574.1@$i@C@HapC\n" |sed 's/@/\t/g'>> ATGC.tsv
java -jar biostar214299.jar --samoutputformat BAM -p ATGC.tsv SRR17968711_12_CAU_Silkie_Fm_subseted.bam > "$i"_"$kl".bam
