...
echo $pos1 $pos2 $count_AA $count_AT $count_AG $count_AC $count_TA $count_TT $count_TG $count_TC $count_GA $count_GT $count_GG $count_GC $count_CA $count_CT $count_CG $count_CC >> Dup1_PacBio_HDP_pair_count.txt
done

####DUP2 Phasing
for i in `cat dup2_pair`
do
pos1=`echo $i |sed 's/_/\t/g'|cut -f1`
pos2=`echo $i |sed 's/_/\t/g'|cut -f2`
...
echo $pos1 $pos2 $count_AA $count_AT $count_AG $count_AC $count_TA $count_TT $count_TG $count_TC $count_GA $count_GT $count_GG $count_GC $count_CA $count_CT $count_CG $count_CC >> Dup2_PacBio_HDP_pair_count.txt
done
