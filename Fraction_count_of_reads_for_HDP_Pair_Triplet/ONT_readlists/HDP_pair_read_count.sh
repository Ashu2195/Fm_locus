...
echo $pos1 $pos2 $count_AA $count_AT $count_AG $count_AC $count_TA $count_TT $count_TG $count_TC $count_GA $count_GT $count_GG $count_GC $count_CA $count_CT $count_CG $count_CC >> Dup1_ONT_HDP_pair_count.txt
done
...
echo $pos1 $pos2 $count_AA $count_AT $count_AG $count_AC $count_TA $count_TT $count_TG $count_TC $count_GA $count_GT $count_GG $count_GC $count_CA $count_CT $count_CG $count_CC >> Dup2_ONT_HDP_pair_count.txt
done
